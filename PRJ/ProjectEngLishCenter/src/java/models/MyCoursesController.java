...
public class MyCoursesController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int studentId = acc.getStudentId();

        MyCoursesDAO dao = new MyCoursesDAO();
        List<MyCourses> list = dao.getMyCourses(studentId);

        request.setAttribute("mycourses", list);

        request.getRequestDispatcher("views/MyCourses.jsp")
