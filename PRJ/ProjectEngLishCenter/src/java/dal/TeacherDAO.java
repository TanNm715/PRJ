...
public class TeacherDAO extends DBContext {
    ...
    public int insertTeacher(String name, String phone, String email) {
        int teacherId = -1;
        try {
            String sql = """
    ...
    public void insertSpecialize(int teacherId, String[] specIds) {

    String sql = """
                 INSERT INTO Specialize(teacher_id, specialization_id) 
                 VALUES (?,?)
                 """;
    try {
        PreparedStatement ps = connection.prepareStatement(sql);
